...
<body>
  ...
  ?>
    ...
    if($result[7]=='1'){
     echo '<iframe id="mainFrame" src="zdy.php?yys=<?php echo $index ?>" style="border-width: 0px;width: 100vw;height: 92vh;overflow:visible;">
      </iframe>';   
            
        } else {
    echo '<iframe id="mainFrame" src="ka.php?yys=<?php echo $index ?>" style="border-width: 0px;width: 100vw;height: 92vh;overflow:visible;">
      </iframe>';   
        }
  ?>
